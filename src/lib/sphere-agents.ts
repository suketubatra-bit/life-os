...
export const SPHERE_AGENTS: SphereAgent[] = [
  {
    id: 'praan', name: 'Praan', meaning: 'Life Force', emoji: '💪',
  ...
  {
    id: 'arjun', name: 'Arjun', meaning: 'Focused Achiever', emoji: '🚀',
  ...
  {
    id: 'lakshmi', name: 'Lakshmi', meaning: 'Prosperity', emoji: '💰',
  ...
  {
    id: 'vidya', name: 'Vidya', meaning: 'Knowledge', emoji: '📚',
  ...
  {
    id: 'kala', name: 'Kala', meaning: 'Art & Craft', emoji: '🎨',
  ...
  {
    id: 'mitra', name: 'Mitra', meaning: 'Companion', emoji: '🫂',
  ...
  {
    id: 'ananda', name: 'Ananda', meaning: 'Bliss', emoji: '🧘',
  ...
  {
    id: 'griha', name: 'Griha', meaning: 'Home', emoji: '🏡',
